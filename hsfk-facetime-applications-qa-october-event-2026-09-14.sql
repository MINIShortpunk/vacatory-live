-- HSFK FaceTime: Applications Advice & Q&A (October)
-- Official Candidats source checked 14 September 2026:
-- https://hsfkramer.app.candidats.io/event/c68001b9-8142-41c2-853b-b9cb4fdfcbe6
...
declare
  ...
  v_url text := 'https://hsfkramer.app.candidats.io/event/c68001b9-8142-41c2-853b-b9cb4fdfcbe6';
  v_slug text := 'facetime-applications-advice-qa-october-2026';
...
begin
  ...
  if v_programme_id is null then
    insert into firm_programmes (
      ...
      gen_random_uuid(), v_org, v_org, v_slug, 'United Kingdom - FaceTime: Applications Advice & Q&A (October)', 'event',
      ...
      '23 October 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
      date '2026-10-23', date '2026-10-23', v_url, v_url,
      false, false, true, true, true,
      date '2026-09-14', date '2026-10-24', 481, 'exact',
    ...
    set programme_name = 'United Kingdom - FaceTime: Applications Advice & Q&A (October)',
        ...
        programme_date_summary = '23 October 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
        programme_starts_on = date '2026-10-23',
        programme_ends_on = date '2026-10-23',
        ...
        next_review_on = date '2026-10-24',
        updated_at = now()
  ...
  if v_opportunity_id is null then
    ...
    insert into career_opportunities (
      ...
      v_opportunity_id, v_org, v_opp_type, v_event_type, v_slug, 'FaceTime: Applications Advice & Q&A (October)',
      'FaceTime: Applications Advice & Q&A (October)', 'FaceTime: Applications Advice & Q&A (October)',
      ...
      'online', v_url, v_url, true, true, 481, date '2026-09-14', date '2026-10-24', false, now(), now()
    );
  else
    update career_opportunities
    set opportunity_type_id = v_opp_type,
        event_type_id = v_event_type,
        official_name = 'FaceTime: Applications Advice & Q&A (October)',
        english_name = 'FaceTime: Applications Advice & Q&A (October)',
        public_name = 'FaceTime: Applications Advice & Q&A (October)',
  ...
  if not exists (select 1 from career_opportunity_cycles where opportunity_id = v_opportunity_id and cycle_key = '2026-10-23') then
    insert into career_opportunity_cycles (
      ...
      gen_random_uuid(), v_opportunity_id, '2026-10-23', '23 October 2026', 'rolling', 'exact',
      2026, 2026, 'Registration is open; no separate closing date is published.', date '2026-10-23', date '2026-10-23',
      '23 October 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.', '90 minutes',
    ...
    set application_model = 'rolling',
        ...
        programme_dates_text = '23 October 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
