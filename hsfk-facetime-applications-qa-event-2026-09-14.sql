-- HSFK FaceTime: Applications Advice & Q&A (September)
-- Official Candidats source checked 14 September 2026:
-- https://hsfkramer.app.candidats.io/event/18dc330f-94aa-4921-9dfb-bded8592c7de
...
declare
  ...
  v_url text := 'https://hsfkramer.app.candidats.io/event/18dc330f-94aa-4921-9dfb-bded8592c7de';
  v_slug text := 'facetime-applications-advice-qa-september-2026';
...
begin
  ...
  if v_programme_id is null then
    insert into firm_programmes (
      ...
      gen_random_uuid(), v_org, v_org, v_slug, 'United Kingdom - FaceTime: Applications Advice & Q&A (September)', 'event',
      ...
      '25 September 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
      date '2026-09-25', date '2026-09-25', v_url, v_url,
      false, false, true, true, true,
      date '2026-09-14', date '2026-09-26', 480, 'exact',
    ...
    set programme_name = 'United Kingdom - FaceTime: Applications Advice & Q&A (September)',
        ...
        programme_date_summary = '25 September 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
        programme_starts_on = date '2026-09-25',
        programme_ends_on = date '2026-09-25',
        ...
        next_review_on = date '2026-09-26',
        updated_at = now()
  ...
  if v_opportunity_id is null then
    ...
    insert into career_opportunities (
      ...
      v_opportunity_id, v_org, v_opp_type, v_event_type, v_slug, 'FaceTime: Applications Advice & Q&A (September)',
      'FaceTime: Applications Advice & Q&A (September)', 'FaceTime: Applications Advice & Q&A (September)',
      ...
      'online', v_url, v_url, true, true, 480, date '2026-09-14', date '2026-09-26', false, now(), now()
    );
  else
    update career_opportunities
    set opportunity_type_id = v_opp_type,
        event_type_id = v_event_type,
        official_name = 'FaceTime: Applications Advice & Q&A (September)',
        english_name = 'FaceTime: Applications Advice & Q&A (September)',
        public_name = 'FaceTime: Applications Advice & Q&A (September)',
  ...
  if not exists (select 1 from career_opportunity_cycles where opportunity_id = v_opportunity_id and cycle_key = '2026-09-25') then
    insert into career_opportunity_cycles (
      ...
      gen_random_uuid(), v_opportunity_id, '2026-09-25', '25 September 2026', 'rolling', 'exact',
      2026, 2026, 'Registration is open; no separate closing date is published.', date '2026-09-25', date '2026-09-25',
      '25 September 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.', '90 minutes',
    ...
    set application_model = 'rolling',
        ...
        programme_dates_text = '25 September 2026, 12:00–13:30 UK time, virtual on Microsoft Teams.',
        duration_text = '90 minutes',
        audience_text = 'Students interested in early careers at HSFK.',
