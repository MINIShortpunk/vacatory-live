-- HSFK FaceTime: Non Law Into Law
-- Official Candidats source checked 14 September 2026:
-- https://hsfkramer.app.candidats.io/event/9c5cb373-fd55-49a2-81c1-8198fb0d6a73
...
declare
  ...
  v_url text := 'https://hsfkramer.app.candidats.io/event/9c5cb373-fd55-49a2-81c1-8198fb0d6a73';
  v_slug text := 'facetime-non-law-into-law-2026';
...
begin
  ...
  if v_programme_id is null then
    insert into firm_programmes (
      ...
      eligible_study_stage, audience_text, primary_source_url, application_url,
      ...
      gen_random_uuid(), v_org, v_org, v_slug, 'United Kingdom - FaceTime: Non Law Into Law', 'event',
      'Non-law students interested in commercial law', 'event', 'United Kingdom', 'Virtual', 'online',
      'Virtual HSFK event for students from non-law backgrounds considering commercial law, with trainees discussing routes into law, transferable skills and the application process.',
      'upcoming', 'current', 'in_scope',
      'Registration is open; no separate closing date is published.',
      '6 November 2026, 12:00–13:30 UK time, virtual.',
      date '2026-11-06', date '2026-11-06',
      'Students from non-law degree backgrounds.',
      'Students from non-law backgrounds considering a career in commercial law.',
      v_url, v_url,
      false, false, true, true, true,
      date '2026-09-14', date '2026-11-07', 482, 'exact',
    ...
    set programme_name = 'United Kingdom - FaceTime: Non Law Into Law',
        programme_type = 'event',
        career_stage = 'Non-law students interested in commercial law',
        opportunity_level = 'event',
        country_text = 'United Kingdom',
        location_text = 'Virtual',
        delivery_mode = 'online',
        description = 'Virtual HSFK event for students from non-law backgrounds considering commercial law, with trainees discussing routes into law, transferable skills and the application process.',
        ...
        programme_date_summary = '6 November 2026, 12:00–13:30 UK time, virtual.',
        programme_starts_on = date '2026-11-06',
        programme_ends_on = date '2026-11-06',
        eligible_study_stage = 'Students from non-law degree backgrounds.',
        audience_text = 'Students from non-law backgrounds considering a career in commercial law.',
        ...
        next_review_on = date '2026-11-07',
        updated_at = now()
  ...
  if v_opportunity_id is null then
    ...
    insert into career_opportunities (
      ...
      v_opportunity_id, v_org, v_opp_type, v_event_type, v_slug, 'FaceTime: Non Law Into Law',
      'FaceTime: Non Law Into Law', 'FaceTime: Non Law Into Law',
      'Virtual HSFK event for students from non-law backgrounds considering commercial law, covering routes into law, transferable skills and the application process.',
      'online', v_url, v_url, true, true, 482, date '2026-09-14', date '2026-11-07', false, now(), now()
    );
  else
    update career_opportunities
    set opportunity_type_id = v_opp_type,
        event_type_id = v_event_type,
        official_name = 'FaceTime: Non Law Into Law',
        english_name = 'FaceTime: Non Law Into Law',
        public_name = 'FaceTime: Non Law Into Law',
        public_summary = 'Virtual HSFK event for students from non-law backgrounds considering commercial law, covering routes into law, transferable skills and the application process.',
        delivery_mode = 'online',
        official_url = v_url,
        application_url = v_url,
        active = true,
  ...
  if not exists (select 1 from career_opportunity_cycles where opportunity_id = v_opportunity_id and cycle_key = '2026-11-06') then
    insert into career_opportunity_cycles (
      ...
      duration_text, audience_text, eligibility_text, application_process_text, official_url, application_url, source_status, source_status_note,
      research_checked_on, active, created_at, updated_at
    ) values (
      gen_random_uuid(), v_opportunity_id, '2026-11-06', '6 November 2026', 'rolling', 'exact',
      2026, 2026, 'Registration is open; no separate closing date is published.', date '2026-11-06', date '2026-11-06',
      '6 November 2026, 12:00–13:30 UK time, virtual.', '90 minutes',
      'Students from non-law backgrounds considering a career in commercial law.', 'Students from non-law degree backgrounds.',
    ...
    set application_model = 'rolling',
        ...
        programme_dates_text = '6 November 2026, 12:00–13:30 UK time, virtual.',
        duration_text = '90 minutes',
        audience_text = 'Students from non-law backgrounds considering a career in commercial law.',
        eligibility_text = 'Students from non-law degree backgrounds.',
