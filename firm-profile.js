...
const vacatoryFirmConfirmedEmptyMessages=Object.freeze({
  opportunities:"No current or upcoming student opportunities are published for this firm at the moment.",
  opportunityFilter:"No opportunities match these filters.",
  payFundingVisas:"No detailed UK visa or funding information has been published for this firm yet.",
  inclusionDisability:"No detailed EDI information has been published for this firm yet.",
  proBono:"No detailed pro bono information has been published for this firm yet.",
  firmHighlights:"No firm highlights have been published for this firm yet.",
  linksSocials:"No verified official links or social accounts have been published for this firm yet."
});
...
async function loadPayFundingVisas(){
  ...
  const items=[
    vacatoryRenderUkVisaFundingCard({
      ...
      opportunityEntries:visaOpportunityEntries,
      researchEntries:visaResearchEntries
    }),
    vacatoryRenderUkVisaFundingCard({
